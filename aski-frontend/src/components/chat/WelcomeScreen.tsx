  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        boxShadow: '0 0 40px rgba(91,106,240,0.35)',
        position: 'relative',
      }}>
      ...
      <h1 style={{
        ...
        color: '#f0f4ff', margin: '0 0 12px', textAlign: 'center',
        ...
        {[
          ...
          <span
            ...
            style={{
              ...
              color: pill.color, background: `${pill.color}12`,
      ...
      {/* Suggested questions */}
      <div style={{ width: '100%' }}>
        <p style={{ fontSize: 11, fontWeight: 700, color: '#334155', letterSpacing: '0.08em', textAlign: 'center', marginBottom: 14, textTransform: 'uppercase' }}>
          Try asking
        </p>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
          {SUGGESTED_QUESTIONS.map((q, i) => (
            <button
              ...
              onMouseEnter={e => {
                e.currentTarget.style.background = 'rgba(91,106,240,0.1)'
                e.currentTarget.style.borderColor = 'rgba(91,106,240,0.25)'
                e.currentTarget.style.transform = 'translateY(-1px)'
              }}
              onMouseLeave={e => {
                e.currentTarget.style.background = 'rgba(26,37,64,0.6)'
            ...
            >
              ...
              <div>
                <div style={{ fontSize: 10, fontWeight: 700, color: '#475569', letterSpacing: '0.06em', marginBottom: 4, textTransform: 'uppercase' }}>
                  {q.category}
                </div>
